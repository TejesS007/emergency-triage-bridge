...
async def analyze_emergency(
    ...
    # Validate that at least one modality has input
    ...
    # Perform Gemini Multimodal Triage
    ...
    # Locate nearest hospital via Google Places
    hospital = get_nearest_hospital()

    # Build shareable text summary locally with Python f-string
